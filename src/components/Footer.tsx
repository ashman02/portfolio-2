...
const Footer = () => {
  return (
    <footer className="bg-foreground w-full -mt-2 flex flex-col items-center justify-center gap-4 px-2 pb-4 pt-6 md:flex-row md:justify-between md:px-4 md:pb-12 md:pt-14 lg:px-16">
